...
from minigpt4.datasets.datasets.engine_vqa_datasets import ENGINEDAVQADataset, ENGINEMCVQADataset, ENGINEMCPVQADataset
...
# engine r3
@registry.register_builder("engine_da")
class COCOVQABuilder(BaseDatasetBuilder):
    train_dataset_cls = ENGINEDAVQADataset

    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/engine/da.yaml",
    }
    
@registry.register_builder("engine_mc")
class COCOVQABuilder(BaseDatasetBuilder):
    train_dataset_cls = ENGINEMCVQADataset

    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/engine/mc.yaml",
    }
    
@registry.register_builder("engine_mcp")
class COCOVQABuilder(BaseDatasetBuilder):
    train_dataset_cls = ENGINEMCPVQADataset

    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/engine/mcp.yaml",
    }