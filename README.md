...
1. **MLLM-DataEngine**, a novel closed-loop system that bridges data generation, model training, and evaluation. 

2. **DataEngine-InstData**, high-quality and targeted VQA data generated by MLLM-DataEngine, also refered to as GPTVQA in paper.

![overview](assets/DataEngine.jpg)
